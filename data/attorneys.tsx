const ATTORNEYS_DATA = {
  ...
  'andrew-seitz': {
    name: 'Andrew Seitz',
    pathName: 'andrew-seitz',
    imageUrl: '/images/attorneys/andrew-seitz.jpg',
    description:
      'Andrew earned his bachelor’s degree from Penn State University and was awarded his Juris Doctor degree from Pepperdine University School of Law, where he was a Dean’s Merit Scholar. <br> Andrew is the author of a law review article titled, “It’s a Series of Tubes: Network Neutrality in the United States,” published in the Journal of the National Association of Administrative Law Judiciary  in Fall, 2009. Andrew was admitted to the State Bar of California in 2010.',
    content:
